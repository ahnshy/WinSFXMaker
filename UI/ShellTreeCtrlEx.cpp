...
// CShellTreeCtrlEx
IMPLEMENT_DYNAMIC(CShellTreeCtrlEx, CMFCShellTreeCtrl)

CShellTreeCtrlEx::CShellTreeCtrlEx()
{
	m_bInit		= FALSE;
	m_pContainer= NULL;
}
...
BEGIN_MESSAGE_MAP(CShellTreeCtrlEx, CMFCShellTreeCtrl)
	//ON_WM_ERASEBKGND()
	//ON_NOTIFY_REFLECT(TVN_ITEMCHANGING, &CShellTreeCtrlEx::OnTvnSelChanged)
END_MESSAGE_MAP()
...
//void CShellTreeCtrlEx::OnTvnSelChanged(NMHDR* pNMHDR, LRESULT* pResult) 
//{
...
BOOL CShellTreeCtrlEx::OnChildNotify(UINT message, WPARAM wParam, LPARAM lParam, LRESULT* pLResult)
{
...
void CShellTreeCtrlEx::SetNotifyContainer(CWnd* pContainer)
{
	m_pContainer = pContainer;
}
// CShellTreeCtrlEx message handlers
...
//HRESULT CShellTreeCtrlEx::EnumObjects(HTREEITEM hParentItem, LPSHELLFOLDER pParentFolder, LPITEMIDLIST pidlParent)
//{
//	ASSERT_VALID(this);
